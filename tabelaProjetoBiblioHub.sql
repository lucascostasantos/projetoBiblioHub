create table bibliohub.Biblioteca(
	...
	hr_funcionamento time not null

);

create table bibliohub.TelefonesBiblio(
	
	cnpj varchar(50) references bibliohub.Biblioteca(cnpj) not null,
...
create table bibliohub.Sessao(
	...
	ISBN varchar(60) references bibliohub.Livros(ISBN) unique,
...
create table bibliohub.Emprestimo(
	...
	ISBN varchar(60) references bibliohub.Livros(ISBN)
...
create table bibliohub.ConsultarLivros_Biblio(
	...
	cnpj varchar(50) references bibliohub.Biblioteca(cnpj) not null,
	ISBN varchar(60) references bibliohub.Livros(ISBN) not null,
